---
name: markitdown
description: "将各种文件和办公文档转换为 Markdown 格式。支持 PDF、DOCX、PPTX、XLSX、图片（OCR 识别）、音频（语音转文字）、HTML、CSV、JSON、XML、ZIP、YouTube 链接、EPub 等格式。"
...
**优先使用 CLI，一次命令完成转换，无需写 Python 代码。**
...
markitdown data.xlsx -o data.csv
